...
TEXT_PATH = '/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/shendiaoxialv.txt'  # 文本路径
DICT_PATH = '/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/person.txt'  # 人物字典路径
SYNONYMOUS_DICT_PATH = '/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/synonymous_dict.txt'  # 同义词路径
SAVE_NODE_PATH = '/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/node.csv'
SAVE_EDGE_PATH = '/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/edge.csv'
...
class RelationshipView:
    ...
    def save_node_and_edge(self):
        ...
        :return:
        '''
        dataframe = pd.DataFrame({self._person_counter})
        dataframe.to_csv("/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/node1.csv", index=False, sep=',')


        '''
        file_obj = open('/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/node1.csv','a', newline='')
       # file_obj.write(codecs.BOM_UTF8)
        writer = csv.writer(file_obj,dialect='excel')
        head=['Id','Lable','Weight']
        writer.writerow(head)
        for name, times in self._person_counter.items():
            row=[name,name,str(times)]
            writer.writerow(row)

        file_obj = open('/Users/zhouxiaocong/Documents/pythoncode/text/shendiaoxialv/edge1.csv', 'w')
        #file_obj.write(codecs.BOM_UTF8)
        writer = csv.writer(file_obj,dialect='excel')
